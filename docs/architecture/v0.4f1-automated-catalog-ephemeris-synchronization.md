...
The separate v0.4F.2 development work schedules canonical conjunction
screening after these inputs are maintained. Its cadence, database authority,
shared screening lock and retry state are documented in
[v0.4F.2 — Automated Conjunction Screening](v0.4f2-automated-conjunction-screening.md).
